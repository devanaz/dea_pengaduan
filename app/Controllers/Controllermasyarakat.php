...
class Controllermasyarakat extends BaseController
{
	...
	public function daftar(){
		...
		// $this-> masyarakat-> update($this->request->getPost(''),$txtNikdata);
	...
	/* public function save_register(){
		...
		if (!$this->validate([
			'nama' => [
				...
				'username' => [
					'rules' => 'required|is_unique[masyarakat.username]|is_numeric',
					'errors' => [
				...
				'nik' => [
					...
					'errors' =>[
						...
						'is_unique' => 'NIK yang anda masukan sudah terdaftar',
				...
				'telp' => [
					...
					'errors' =>[
						...
						'is_unique' => 'Nomor Telepon yang anda masukan sudah terdaftar',
