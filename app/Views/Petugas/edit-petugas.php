...
<input type="text" name="txtInputTelp" class="form-control" placeholder="Masukan No Telephone petugas" value="<?=$detailPetugas[0]['telp'];?>" autocomplete="off" autofocous reaquire >
</div>
<div class="form-group">
